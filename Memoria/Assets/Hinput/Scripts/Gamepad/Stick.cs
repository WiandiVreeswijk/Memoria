	...
	public class Stick {
		...
		public Stick(string stickName, Gamepad gamepad, int index, bool isEnabled) {
			...
			if (index == 0 || index == 1) { // Sticks
				horizontalAxis = new Axis (Internal.Utils.os + "_" + name + "_Horizontal");
				verticalAxis = new Axis (Internal.Utils.os + "_" + name + "_Vertical");
			}
			
			if (index == 2) { // DPad
				horizontalAxis = new Axis (Internal.Utils.os + "_" + name + "_Horizontal",
					Internal.Utils.os + "_" + name + "_Right", 
					Internal.Utils.os + "_" + name + "_Left");
				verticalAxis = new Axis (Internal.Utils.os + "_" + name + "_Vertical", 
					Internal.Utils.os + "_" + name + "_Up",
					Internal.Utils.os + "_" + name + "_Down");
			}
		}
		...
		protected virtual Vector2 GetPosition() {
			...
			return (Internal.Utils.stickPositionMultiplier/(1 - Settings.stickDeadZone) 
